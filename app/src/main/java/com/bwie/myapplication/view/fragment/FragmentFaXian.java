...
import com.bwie.myapplication.view.acitvity.MainActivity;
import com.bwie.myapplication.view.fragment.FaXian.ShengShiLianDong.JsonFileReader;
import com.bwie.myapplication.view.fragment.FaXian.ShengShiLianDong.ProvinceBean;
...
public class FragmentFaXian extends Fragment {
    ...
    @BindView(R.id.chek_newest_version)
    Button gengxin;
    Unbinder unbinder;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        gengxin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CretinAutoUpdateUtils.getInstance(getActivity()).check();
        ...
        //  获取json数据
        String province_data_json = JsonFileReader.getJson(getActivity(), "province.json");
        //  解析json数据
